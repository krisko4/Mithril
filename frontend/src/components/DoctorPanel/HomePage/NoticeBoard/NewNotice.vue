        ...
        saveNotice() {
            ...
            tokenAxios.post('notices', requestNotice)
                .then(() => {
                    ...
                    // let notice = {
                    //     img: 'http://localhost:8080/images/doctors/' + localStorage.getItem('imageName'),
                    //     title: requestNotice.title,
                    //     content: requestNotice.content,
                    //     doctorName: localStorage.getItem('firstName') + ' ' + localStorage.getItem('lastName'),
                    //     date: requestNotice.date
                    // }
                    // this.$emit('newNoticeSaved', notice)
                })
        }
    }
}
